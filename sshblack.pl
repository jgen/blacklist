...
my($OUTPUTLOG) = '/var/log/blacklist/ssh.log';
#
...
# ######### ########### IPTABLES VERSION ############ ###########
#
my($ADDRULE) = '/sbin/iptables -I SSHBLACKLIST 1 -s ipaddress -j LOGNDROP';
...
# ######### ########### IPTABLES VERSION ############ ###########
#
my($DELRULE) = '/sbin/iptables -D SSHBLACKLIST -s ipaddress -j LOGNDROP';
